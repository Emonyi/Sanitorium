	...
	<body>
		<!--start-wrap-->
			...
			<div class="header">
				...
				<!--start-logo-->
				<div class="logo">
					<a href="index.html" style="font-size: 30px;">E.U.SANATORIUM</a>
				</div>
				<!--end-logo-->
				<!--start-top-nav-->
				<div class="top-nav">
		    ...
		    <div class="content-grids">
				...
				<div class="listview_1_of_3 images_1_of_3">
					...
					<div class="text list_1_of_2">
						  <h3>Doctors Login</h3>
							<p>Login </p>
						  <div class="button"><span><a href="doctorlog.php">Click Here</a></span></div>
					</div>
				</div>
					<div class="listview_1_of_3 images_1_of_3">
					<div class="listimg listimg_1_of_2">
